...
def downgrade():
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('product_type_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('data_field', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True),
    sa.Column('product_type_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['product_type_id'], ['product_type.id'], name='product_product_type_id_fkey'),
